...
class RequestMsg :
 ...
 public:
  ...
  const std::string& severid() const;
  void set_severid(const std::string& value);
  void set_severid(std::string&& value);
  void set_severid(const char* value);
  void set_severid(const void* value, size_t size);
  std::string* mutable_severid();
  std::string* release_severid();
  void set_allocated_severid(std::string* severid);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr severid_;
...
// bytes severId = 3;
inline void RequestMsg::clear_severid() {
  severid_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RequestMsg::severid() const {
  // @@protoc_insertion_point(field_get:RequestMsg.severId)
  return severid_.GetNoArena();
}
inline void RequestMsg::set_severid(const std::string& value) {
  
  severid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:RequestMsg.severId)
}
inline void RequestMsg::set_severid(std::string&& value) {
  
  severid_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:RequestMsg.severId)
}
inline void RequestMsg::set_severid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  severid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:RequestMsg.severId)
}
inline void RequestMsg::set_severid(const void* value, size_t size) {
  
  severid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:RequestMsg.severId)
}
inline std::string* RequestMsg::mutable_severid() {
  
  // @@protoc_insertion_point(field_mutable:RequestMsg.severId)
  return severid_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RequestMsg::release_severid() {
  // @@protoc_insertion_point(field_release:RequestMsg.severId)
  
  return severid_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RequestMsg::set_allocated_severid(std::string* severid) {
  if (severid != nullptr) {
    
  } else {
    
  }
  severid_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), severid);
  // @@protoc_insertion_point(field_set_allocated:RequestMsg.severId)
}
